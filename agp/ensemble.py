...
class PanelVerdict:
    ...
    def apply(self, confidence_score: float) -> tuple[float, str]:
        ...
        if self.has_blocking:
            ...
            # A refused seal reports the score it REFUSED, quantised DOWN
            # (floor_conf) — round() on this path reported 0.84 for a vetoed
            # 0.836, an inflation in the refusal record itself.
