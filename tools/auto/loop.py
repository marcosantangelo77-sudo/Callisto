...
class AutonomousLoop:
    ...
    def _get_pace_model_confirmation(self, sport: str, game_name: str, report: dict) -> dict:
        ...
        """
        from tools.auto.loop_inj import get_pace_model_confirmation
        return get_pace_model_confirmation(self, sport, game_name, report)
    ...
    async def _refresh_injury_cache(self, sport: str) -> dict:
        ...
        from tools.auto.loop_inj import refresh_injury_cache
        return await refresh_injury_cache(self, sport)

    def _get_injuries_for_game(self, sport: str, game_name: str) -> list[dict]:
        """Extract injuries relevant to a specific game from cache."""
        from tools.auto.loop_inj import get_injuries_for_game
        return get_injuries_for_game(self, sport, game_name)
