"""System watchdog and pipeline-integrity ResearchLoop phases, extracted from post_live.
...
These phases audit pipelines and demote nothing into live betting.
They do not add live to paper-signal.
"""
