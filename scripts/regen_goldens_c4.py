...
notes), regenerate the golden fixtures. scripts/discriminate_goldens_c4.py
verifies the ONLY changed field is 'notes'; zero score/tier/stance/seal
changes in any fixture.
"""
